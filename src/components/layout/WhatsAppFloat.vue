...
<template>
  ...
  >
    <a
      ...
      class="fixed right-5 bottom-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/40 transition-transform hover:scale-105"
      aria-label="Falar no WhatsApp"
      @click="trackContactClick('whatsapp-float')"
    >
